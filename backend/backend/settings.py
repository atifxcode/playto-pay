...
MIDDLEWARE = [
    ...
    'merchants.middleware.MerchantContextMiddleware',
...
# Local fallback: when REDIS_URL is not explicitly provided in env,
# run Celery tasks eagerly so payout processing works end-to-end.
